...
//$part = mysql_fetch_assoc($part);
					//echo  "$ part is:" .$part['research_id']."type is :".gettype($part['research_id'])."<br>";
if(!is_string($part)){
					if(mysql_num_rows($part) >0){ // if the user participates as a subject in any research
